...
public class SerializableDoor : SerializableObject
{
	...
	private DoorVariant DoorPrefab
	{
		get
		{
			...
			{
				DoorType.Lcz => PrefabHelper.GetPrefab<DoorVariant>(Exiled.API.Enums.PrefabType.LCZBreakableDoor),
				DoorType.Hcz => PrefabHelper.GetPrefab<DoorVariant>(Exiled.API.Enums.PrefabType.HCZBreakableDoor),
				DoorType.Ez => PrefabHelper.GetPrefab<DoorVariant>(Exiled.API.Enums.PrefabType.EZBreakableDoor),
				DoorType.Bulkdoor => PrefabHelper.GetPrefab<DoorVariant>(Exiled.API.Enums.PrefabType.HCZBulkDoor),
