...
public class SerializableWorkstation : SerializableObject
{
	...
	{
		WorkstationController workstation = instance == null ? PrefabHelper.Spawn<WorkstationController>(PrefabType.WorkstationStructure) : instance.GetComponent<WorkstationController>();
