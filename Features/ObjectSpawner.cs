...
public static class ObjectSpawner
{
    ...
    public static List<SchematicObject> GetAllSchematics()
    {
        List<SchematicObject> result = new List<SchematicObject>();

        foreach (MapSchematic map in MapUtils.LoadedMaps.Values)
        {
            foreach (SchematicObject schematic in GameObject.FindObjectsOfType<SchematicObject>())
            {
